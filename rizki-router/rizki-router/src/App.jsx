...
import { 
  ...
  Bath, CircleDot, CookingPot, Waves, Home, Factory
} from 'lucide-react';

const WA_NUMBER = "6281286330248";
const INSTA_URL = "https://www.instagram.com/pipamampetsolution";
const LOGO_URL = "https://cdn.phototourl.com/free/2026-07-25-f5641874-6619-4523-aaa2-a316787cdfbb.jpg";
...
const SERVICES = [
  { id: 'wc', title: 'WC Mampet', icon: <Bath className="w-[26px] h-[26px] transition-transform duration-200 group-hover:scale-[1.08]" />, desc: 'Atasi WC mampet, saluran pembuangan macet, dan masalah septic tank tanpa perlu membongkar lantai toilet Anda.' },
  ...
  { id: 'piparumah', title: 'Pipa Rumah', icon: <Home className="w-[26px] h-[26px] transition-transform duration-200 group-hover:scale-[1.08]" />, desc: 'Inspeksi dan pelancaran instalasi pipa air bersih maupun kotor di perumahan dan apartemen.' },
